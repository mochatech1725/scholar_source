...
class CourseInputRequest(BaseModel):
    ...
    bypass_cache: Optional[bool] = Field(False, description="Bypass cache - skip cached results and get fresh results (deprecated, use bypass_cache_analysis / bypass_cache_results)")
    bypass_cache_analysis: Optional[bool] = Field(False, description="Bypass search criteria cache (textbook/topics extraction)")
    bypass_cache_results: Optional[bool] = Field(False, description="Bypass results cache (full resource list)")
